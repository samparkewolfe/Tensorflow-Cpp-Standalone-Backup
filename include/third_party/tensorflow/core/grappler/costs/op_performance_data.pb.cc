...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, sizeof(OpInfo)},
  { 18, -1, sizeof(NormalDistribution)},
  { 25, -1, sizeof(LogNormalDistribution)},
  { 32, -1, sizeof(OpPerformance_OpMemory)},
  { 42, -1, sizeof(OpPerformance)},
  { 59, -1, sizeof(OpPerformanceList)},
};
...
file_level_metadata[0].reflection = OpInfo::OpInfo_AttrEntry::CreateReflection(file_level_metadata[0].descriptor, _OpInfo_AttrEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _OpInfo_AttrEntry_default_instance_._instance.DefaultConstruct();
...
::google::protobuf::Metadata OpInfo::OpInfo_AttrEntry::GetMetadata() const {
  ...
  return protobuf_tensorflow_2fcore_2fgrappler_2fcosts_2fop_5fperformance_5fdata_2eproto::file_level_metadata[0];
}
...
void OpPerformance_OpMemory::SharedCtor() {
  ::memset(&host_temp_memory_, 0, static_cast<size_t>(
...
void OpPerformance_OpMemory::InternalSwap(OpPerformance_OpMemory* other) {
  ...
  swap(host_temp_memory_, other->host_temp_memory_);
  swap(device_temp_memory_, other->device_temp_memory_);
  swap(host_persistent_memory_, other->host_persistent_memory_);
